...
public class ArthropleuraButtModel extends EntityModel<LivingEntityRenderState> {
	public static final EntityModelLayer ARTHROPLEURA = new EntityModelLayer(Identifier.of(EverbloomDandaloo.MOD_ID, "arthropleura_butt"), "main");
	...
	public ArthropleuraButtModel(ModelPart root) {
        super(root);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bodyright_r1 = body_base.addChild("bodyright_r1", ModelPartBuilder.create().uv(0, 8).cuboid(-1.0F, -1.0F, -1.0F, 4.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 1.0F, 1.0F, -0.0873F, 0.7854F, -0.2618F));

		ModelPartData bodyleft_r1 = body_base.addChild("bodyleft_r1", ModelPartBuilder.create().uv(0, 4).cuboid(-3.0F, -1.0F, -1.0F, 4.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(2.0F, 1.0F, 1.0F, -0.0873F, -0.7854F, 0.2618F));
		...
		ModelPartData bodyright_r2 = body_mid.addChild("bodyright_r2", ModelPartBuilder.create().uv(0, 8).cuboid(-1.0F, -1.0F, -1.0F, 4.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-3.0F, 1.0F, 1.0F, 0.0903F, 0.2608F, -0.2385F));

		ModelPartData bodyleft_r2 = body_mid.addChild("bodyleft_r2", ModelPartBuilder.create().uv(0, 4).cuboid(-3.0F, -1.0F, -1.0F, 4.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(3.0F, 1.0F, 1.0F, 0.0903F, -0.2608F, 0.2385F));

		ModelPartData legmiddleleft = body_mid.addChild("legmiddleleft", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, 1.0F, 0.0F));

		ModelPartData cube_r1 = legmiddleleft.addChild("cube_r1", ModelPartBuilder.create().uv(0, 12).cuboid(0.0F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, 1.0F, 0.0F, 0.0F, 0.0F, -0.7854F));
		...
		ModelPartData cube_r2 = legmiddleright.addChild("cube_r2", ModelPartBuilder.create().uv(10, 12).cuboid(-1.0F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
		...
		ModelPartData cube_r3 = legmiddleleft2.addChild("cube_r3", ModelPartBuilder.create().uv(0, 12).cuboid(0.0F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, 1.0F, 0.0F, 0.0F, 0.0F, -0.7854F));
		...
		ModelPartData cube_r4 = legmiddleright2.addChild("cube_r4", ModelPartBuilder.create().uv(10, 12).cuboid(-1.0F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
	...
	public void setAngles(LivingEntityRenderState state) {
		...
		this.animateWalking(ModAnimations.ARTHROPLEURA_BUTT_ANIMATION.walk, state.limbFrequency, state.limbAmplitudeMultiplier, 2f, 2.5f);
	}
}