...
import tydino.everbloom.entity.dinosaurs.*;
...
public class PteranodonEntity extends FlyingTamableDinosaurEntity {
    ...
    private void setupAnimationStates() {
        ...
        if(flyAnimationTimeout<=0 && !this.isOnGround()) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(6, new TamableDinosaurFollowingGoal(this, (double)1.0F, 10.0F, 2.0F));
        this.goalSelector.add(7, new TamableDinosaurMateGoal(this, 1.0F));
        this.goalSelector.add(8, new TamableDinosaurLayEggGoal(this, 1.0F, DinosaurBlocks.PTERANODON_EGG, 400));
        this.goalSelector.add(9, new TemptGoal(this, 1.05f, CARNIVORE, false));
        this.goalSelector.add(10, new FollowParentGoal(this, 1.25F));
        ...
        this.goalSelector.add(13, new LookAtEntityGoal(this, CompsognathusEntity.class, 15.0F));
