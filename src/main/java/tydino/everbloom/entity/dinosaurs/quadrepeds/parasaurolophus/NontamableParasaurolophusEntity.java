package tydino.everbloom.entity.dinosaurs.quadrepeds.parasaurolophus;
...
public class NontamableParasaurolophusEntity extends ParasaurolophusEntity{
    public NontamableParasaurolophusEntity(EntityType<? extends ParasaurolophusEntity> entityType, World world) {
    ...
    @Override
    public @Nullable ParasaurolophusEntity createChild(ServerWorld world, PassiveEntity passiveEntity) {
        return null;
    }
