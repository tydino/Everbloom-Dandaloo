package tydino.everbloom.screen.power.Grinder;
...
public class GrinderScreenHandler extends ScreenHandler {
    ...
    public final GrinderEntity blockEntity;

    public GrinderScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(pos), new ArrayPropertyDelegate(2));
    }

    public GrinderScreenHandler(int syncId, PlayerInventory playerInventory,
                                              BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandler.GRINDER_SCREEN_HANDLER, syncId);
        this.inventory = ((Inventory) blockEntity);
        this.blockEntity = ((GrinderEntity) blockEntity);
