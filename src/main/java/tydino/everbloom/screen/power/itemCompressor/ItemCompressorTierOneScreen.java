...
public class ItemCompressorTierOneScreen extends HandledScreen<ItemCompressorTierOneScreenHandler> {
    ...
    public ItemCompressorTierOneScreen(ItemCompressorTierOneScreenHandler handler, PlayerInventory inventory, Text title){
