...
public class PowerHectogonTierOneEntity extends BlockEntity implements TickableBlockEntity {
    public PowerHectogonTierOneEntity(BlockPos pos, BlockState state){
        super(ModBlockEntities.POWER_HECTOGON_TIER_ONE_BE, pos, state);
    }

    //power
    public final SimpleEnergyStorage energyStorage = new SimpleEnergyStorage(500, 100, 10) {
        @Override
