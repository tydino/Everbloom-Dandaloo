...
public class HypsilophodonEgg extends Block {
    ...
    public HypsilophodonEgg(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        if (!this.isReadyToHatch(state)) {
            ...
            HypsilophodonEntity baby = (HypsilophodonEntity) ModEntities.HYPSILOPHODON.create(world, SpawnReason.BREEDING);
            if (baby != null) {
