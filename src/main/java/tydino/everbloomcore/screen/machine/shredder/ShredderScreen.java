...
public class ShredderScreen extends HandledScreen<ShredderScreenHandler> {
    static final Identifier GUI_TEXTURE =
            Identifier.of(EverbloomDandalooCore.MOD_ID, "textures/gui/shredder/shredder.png");
    static final Identifier ARROW_TEXTURE =
            Identifier.of(EverbloomDandalooCore.MOD_ID, "textures/gui/arrow_progress_top_bottom.png");

    public ShredderScreen(ShredderScreenHandler handler, PlayerInventory inventory, Text title){
