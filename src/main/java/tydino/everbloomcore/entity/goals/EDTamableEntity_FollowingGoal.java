package tydino.everbloomcore.entity.goals;
...
public class EDTamableEntity_FollowingGoal extends Goal {
    private final EDTamableEntity tameable;
    @Nullable
    ...
    public EDTamableEntity_FollowingGoal(EDTamableEntity tameable, double speed, float minDistance, float maxDistance) {
